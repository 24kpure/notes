 ...
 * @Author: lmj
 * @Description:
 * @Date: Create in 9:48 下午 2020/3/8
 **/
    ...
    private class HandlerThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                // 处理客户端数据
                System.out.println(System.currentTimeMillis()+" count:" + count.addAndGet(1) + "客户端发过来的内容:" + clientInputStr);

                // 向客户端回复信息
                PrintStream out = new PrintStream(socket.getOutputStream());


                out.println(CommandController.handle(clientInputStr));
